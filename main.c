...
void gameDraw()
{
    ...
    SDL_Surface *myp_surf = SDL_LoadBMP("./image/myplane1.bmp");
    SDL_Surface *enp_surf = SDL_LoadBMP("./image/enemy1.bmp");
    SDL_Surface *bull_surf = SDL_LoadBMP("./image/bullet1.bmp");
